...
rid = '29233'#args["rid"].value
tray ='13621733/2,13621743+13621799/1' #args["tray"].value
...
x = ordrin_api.ordrin_api.order_user(rid, tray, tip, first_name,
    last_name, email, current_pw, phone, zipcode, addr, addr2,
    city, state, nick, card_name, card_number, card_cvc,
    card_expiry, card_bill_addr, card_bill_addr2,card_bill_city,
    card_bill_state, card_bill_zip, card_bill_phone,
    card_nick, delivery_date, delivery_time)
