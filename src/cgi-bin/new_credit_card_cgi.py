...
if 'bill_addr2' in args:
  bill_addr2 = args["bill_addr2"]

  try:
    x = ordrin_api.ordrin_api.create_cc(email,card_nick, card_number, card_cvc, card_expiry, bill_addr,bill_city, bill_state, bill_zip, bill_phone, current_pw, bill_addr2)
